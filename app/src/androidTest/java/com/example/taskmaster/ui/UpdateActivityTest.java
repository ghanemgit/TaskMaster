...
public class UpdateActivityTest {
    ...
    @Rule
    public ActivityScenarioRule<UpdateActivity> mActivityRule = new ActivityScenarioRule<>(UpdateActivity.class);

    @Test
    public void ATestEditTextVisibility() {

        onView(withId(R.id.updateTaskTitleBox)).check(matches(withText("Bring Ingredients")));


        onView(withId(R.id.updateTaskDescriptionBox)).check(matches(withText("Go to market and bring some milk and 5 eggs and some butter and don't forget the flour")));
    ...
    public void BTestButtonClick() {
        ...
        onView(withId(R.id.updateTaskTitleBox)).perform(typeText(" V2"), closeSoftKeyboard());
        onView(withId(R.id.updateTaskDescriptionBox)).perform(typeText(" Then go to street."), closeSoftKeyboard());
        onView(withId(R.id.updateTaskDescriptionBox)).perform(closeSoftKeyboard());
...
//        );
    ...
    public void CTestTextAfterUpdate() {
        ...
        onView(withId(R.id.updateTaskTitleBox)).check(matches(withText("Bring Ingredients V2")));


        onView(withId(R.id.updateTaskDescriptionBox)).check(matches(withText("Go to market and bring some milk and 5 eggs and some butte Then go to street.r and don't forget the flour")));
